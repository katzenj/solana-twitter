...
<template>
  <div v-if="connected">
    <div class="px-8 py-4 border-l-4 border-emerald-500">
      <div class="py-1">
      ...
      <div class="flex flex-wrap items-center justify-between -m-2">
        ...
        <div class="relative m-2 mr-4">
          <input
            type="text"
            placeholder="topic"
            class="text-emerald-500 rounded-full pl-10 pr-4 py-2 bg-gray-100"
            :value="slugTopic"
          ...
          <div class="absolute left-0 inset-y-0 flex pl-3 pr-2">
            <svg
              ...
              :class="slugTopic ? 'text-emerald-500' : 'text-gray-400'"
              viewBox="0 0 20 20"
              fill="currentColor"
            >
              <path
        ...
        <div class="flex items-center space-x-4 m-2 ml-auto">
          ...
          <button
            ...
            :disabled="!canTweet"
            :class="
              canTweet ? 'bg-emerald-500' : 'bg-emerald-300 cursor-not-allowed'
            "
            @click="update"
          >
            Update
